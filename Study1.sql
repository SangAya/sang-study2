...
--컬럼 이름 수정
--	학생 아이디 이름을 수정해본다.
ALTER TABLE TBL_stT RENAME COLUMN ID TO studentId;

--컬럼 추가
--	남친여친유무 컬럼 추가
ALTER TABLE TBL_STT ADD(COUPLE CHAR(1));

-- 유니크 키 추가
--	학생 아이디를 유니크 키로 추가
ALTER TABLE TBL_STUDENT DROP CONSTRAINT SYS_C007004;
ALTER TABLE TBL_STT ADD CONSTRAINT UK_STUDENT UNIQUE(studentId);
